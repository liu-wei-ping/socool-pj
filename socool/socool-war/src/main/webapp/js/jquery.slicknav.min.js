...
(function(e, t, n) {
	...
	o.prototype.init = function() {
		...
		n.btn = e("<" + i.parentTag
				+ ' aria-haspopup="true" tabindex="0" class="' + s + "_btn "
				+ s + '_collapsed"><span class="' + s + '_menutxt">' + i.label
				+ '</span><span class="' + o + '"><span class="' + s
				+ '_icon-bar"></span><span class="' + s
				+ '_icon-bar"></span><span class="' + s
		...
		e(a).each(function() {
			...
			if (data.children.length > 0) {
				...
				e(o).last().after('<span class="' + s + '_arrow">'
						+ i.closedSymbol + "</span>")
