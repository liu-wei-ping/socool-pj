...
(function() {
	 ...
	 * @constructor
	 * @param {String |
	 *            HTMLElement} content 用户自定义的Marker内容，可以是字符串，也可以是dom节点
	 * @param {BMap.Point}
	 *            position marker的位置
	 * @param {Json}
	 *            RichMarkerOptions 可选的输入参数，非必填项。可输入选项包括：<br /> {"<b>anchor</b>" :
	 *            {BMap.Size} Marker的的位置偏移值, <br />"<b>enableDragging</b>" :
	 *            {Boolean} 是否启用拖拽，默认为false}
	 * 
	 * @example <b>参考示例：</b> var map = new BMap.Map("container");
	 *          map.centerAndZoom(new BMap.Point(116.309965, 40.058333), 17);
	 *          var htm = "&lt;div
	 *          style='background:#E7F0F5;color:#0082CB;border:1px solid
	 *          #333'&gt;" + "欢迎使用百度地图！" + "&lt;img
	 *          src='http://map.baidu.com/img/logo-map.gif' border='0' /&gt;" +
	 *          "&lt;/div&gt;"; var point = new BMap.Point(116.30816,
	 *          40.056863); var myRichMarkerObject = new BMapLib.RichMarker(htm,
	 *          point, {"anchor": new BMap.Size(-72, -84), "enableDragging":
	 *          true}); map.addOverlay(myRichMarkerObject);
	 */
	...
	/**
	 * 初始化，实现自定义覆盖物的initialize方法 主要生成Marker的主容器，填充自定义的内容，并附加事件
	 * 
	 * @private
	 * @param {BMap}
	 *            map map实例对象
	...
	RichMarker.prototype.initialize = function(map) {
		var me = this, div = me._container = document.createElement("div");
		me._map = map;
	...
	RichMarker.prototype.draw = function() {
		var map = this._map, anchor = this._opts.anchor, pixel = map
				.pointToOverlayPixel(this._position);
	 ...
	 * @return 无返回值
	 * 
	 * @example <b>参考示例：</b> myRichMarkerObject.enableDragging();
	 */
	 ...
	 * @return 无返回值
	 * 
	 * @example <b>参考示例：</b> myRichMarkerObject.disableDragging();
	 */
	 ...
	 * 
	 * @example <b>参考示例：</b> myRichMarkerObject.isDraggable();
	 */
	 ...
	 * 
	 * @example <b>参考示例：</b> myRichMarkerObject.getPosition();
	 */
	 ...
	 * @return 无返回值
	 * 
	 * @example <b>参考示例：</b> myRichMarkerObject.setPosition(new
	 *          BMap.Point(116.30816, 40.056863));
	 */
	 ...
	 * 
	 * @example <b>参考示例：</b> myRichMarkerObject.getAnchor();
	 */
	 ...
	 * @return 无返回值
	 * 
	 * @example <b>参考示例：</b> myRichMarkerObject.setAnchor(new BMap.Size(-72,
	 *          -84));
	 */
	 ...
	 * 
	 * @example <b>参考示例：</b> myRichMarkerObject.getContent();
	 */
	 ...
	 * 
	 * @param {String |
	 *            HTMLElement} content 需要设置的内容
	 * @return 无返回值
	 * 
	 * @example <b>参考示例：</b> var htm = "&lt;div
	 *          style='background:#E7F0F5;color:#0082CB;border:1px solid
	 *          #333'&gt;" + "欢迎使用百度地图API！" + "&lt;img
	 *          src='http://map.baidu.com/img/logo-map.gif' border='0' /&gt;" +
	 *          "&lt;/div&gt;"; myRichMarkerObject.setContent(htm);
	 */
	 ...
	 * @return {Number} 当前宽度
	 * 
	 * @example <b>参考示例：</b> myRichMarkerObject.getWidth();
	 */
	 ...
	 * @return 无返回值
	 * 
	 * @example <b>参考示例：</b> myRichMarkerObject.setWidth(300);
	 */
	 ...
	 * @return {Number} 当前高度
	 * 
	 * @example <b>参考示例：</b> myRichMarkerObject.getHeight();
	 */
	 ...
	 * @return 无返回值
	 * 
	 * @example <b>参考示例：</b> myRichMarkerObject.setHeight(200);
	 */
	...
	RichMarker.prototype._setEventDispath = function() {
		var me = this, div = me._container, isMouseDown = false,
		// 鼠标是否按下，用以判断鼠标移动过程中的拖拽计算
		startPosition = null; // 拖拽时，鼠标按下的初始位置，拖拽的辅助计算参数

		// 通过e参数获取当前鼠标所在位置
		function _getPositionByEvent(e) {
			var e = window.event || e, x = e.pageX || e.clientX || 0, y = e.pageY
					|| e.clientY || 0, pixel = new BMap.Pixel(x, y), point = me._map
					.pixelToPoint(pixel);
			return {
				"pixel" : pixel,
				"point" : point
		...
		baidu.on(div, "onclick", function(e) {
			 ...
			 * @event
			 * @param {Event
			 *            Object} e 回调函数会返回event参数，包括以下返回值： <br />{"<b>target</b> :
			 *            {BMap.Overlay} 触发事件的元素, <br />"<b>type</b>：{String}
			 *            事件类型}
			 * 
			 * @example <b>参考示例：</b>
			 *          myRichMarkerObject.addEventListener("onclick",
			 *          function(e) { alert(e.type); });
			 */
		...
		baidu.on(div, "ondblclick", function(e) {
			 ...
			 *            Object} e 回调函数会返回event参数，包括以下返回值： <br />{"<b>target</b> :
			 *            {BMap.Overlay} 触发事件的元素, <br />"<b>type</b>：{String}
			 *            事件类型, <br />"<b>point</b>：{BMap.Point} 鼠标的物理坐标,
			 *            <br />"<b>pixel</b>：{BMap.Pixel} 鼠标的像素坐标}
			 * 
			 * @example <b>参考示例：</b>
			 *          myRichMarkerObject.addEventListener("ondblclick",
			 *          function(e) { alert(e.type); });
			 */
		...
		div.onmouseover = function(e) {
			 ...
			 * 
			 * @example <b>参考示例：</b>
			 *          myRichMarkerObject.addEventListener("onmouseover",
			 *          function(e) { alert(e.type); });
			 */
		...
		div.onmouseout = function(e) {
			 ...
			 * 
			 * @example <b>参考示例：</b>
			 *          myRichMarkerObject.addEventListener("onmouseout",
			 *          function(e) { alert(e.type); });
			 */
		...
		var mouseUpEvent = function(e) {
			 ...
			 * 
			 * @example <b>参考示例：</b>
			 *          myRichMarkerObject.addEventListener("onmouseup",
			 *          function(e) { alert(e.type); });
			 */
			 ...
			 * 
			 * @example <b>参考示例：</b>
			 *          myRichMarkerObject.addEventListener("ondragend",
			 *          function(e) { alert(e.type); });
			 */
		...
		var mouseMoveEvent = function(e) {
			 ...
			 * 
			 * @example <b>参考示例：</b>
			 *          myRichMarkerObject.addEventListener("ondragging",
			 *          function(e) { alert(e.type); });
			 */
		...
		baidu.on(div, "onmousedown", function(e) {
			 ...
			 * 
			 * @example <b>参考示例：</b>
			 *          myRichMarkerObject.addEventListener("onmousedown",
			 *          function(e) { alert(e.type); });
			 */
			 ...
			 * 
			 * @example <b>参考示例：</b>
			 *          myRichMarkerObject.addEventListener("ondragstart",
			 *          function(e) { alert(e.type); });
			 */
