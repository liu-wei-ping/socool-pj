...
.inactive a:hover, .inactive a.hover {
	background: #2a68a6;
}
</style>
<style type="text/css">
...
#menu ul li {
	...
	line-height: 22px;
	list-style-image:
		url("http://jyzd.gxq.com.cn/public/images/backstage/li.jpg");
}
...
<body>
	<div id="all">
		<div id="banner">
			<h1>PHP</h1>
			<div id="welcome">欢迎!
				${sessionScope['socool_user']['username']} &nbsp;</div>
			<ul id="manage">
				<!--             <li><a class="" href="http://jyzd.sina.com/" target="_blank">官网首页</a></li> -->
				<!--             <li><a href="###" target="b_main" style=C"display: none;">修改密码</a></li> -->
				<li><a class="logout"
					href="${pageContext.request.contextPath}/login/quit.html"
					target="_top">退出管理</a></li>
				<li><a
					href="${pageContext.request.contextPath}/main/index.html"
					target="_top">首 页</a></li>
			</ul>
		</div>
