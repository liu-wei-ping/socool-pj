...
public class MD5Util {
	...
	public static void main(final String args[]) {
		...
		final String tk = "57c0d3cb4fe5761a6e9cb093487ffce2";
		final String t = "1468373720305";
		final String appKey = "12574478";
		final String data = "{\"spm\":\"a2141.7756461.2.6\",\"page\":1,\"tabCode\":\"all\",\"appVersion\":\"1.0\",\"appName\":\"tborder\"}";

		final String s = tk + "&" + t + "&" + appKey + "&" + data;
		final String a = MD5Util.string2MD5("你好");
		final String aa = MD5Util.string2MD5(tk);
	 ...
	 * 加密解密算法 执行一次加密，两次解密
	 */
	public static String xorAchar(final String inStr) {
